...
const OrdersToolbar = ({ searchTerm, setSearchTerm, handleCreateOrder, handleExport, handleFilter }) => {
  return  <>
    <div className="row">
      ...
      <DetailsCard name={'Low Stock Alerts'} count={'24'} icon={<ClockIcon stroke='#5C8DFF' />} />
      <DetailsCard name={'Incoming Shipments'} count={'12'} icon={<TruckIcon fill={'#5C8DFF'} />} />
      <DetailsCard name={'Total Value'} count={'$1.2M'} icon={<TruckCheckIcon stroke='#5C8DFF' />} />
    </div>
