...
//   LogoutIcon, SettingIcon, UserProfileIcon, LockIcon, IntegrateIcon, 
//   BillingIcon} from '../../assets/Icons/SVG.jsx'
...
//   // const isAdminOpen = location.pathname.startsWith('/pages/admin');
...
export default function Sidebar() {
  ...
  return (
    <nav className="navbar sidebar navbar-expand-lg h-100">
      <div className="collapse flex-column navbar-collapse h-100" id="navbarSupportedContent">
        {isSettingsOpen ? <SettingsMenu /> : isAdminOpen ? <AdminMenu /> : <MainMenu />}
      </div>
    </nav>
  );
}
